    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Nickname', max_length=150, unique=True, validators=[django.core.validators.RegexValidator(message='Nickname должен содержать буквы,цифры и символы @.+-_', regex='^[\\w.@+-]+')], verbose_name='Логин')),
                ...
                ('role', models.TextField(choices=[('user', 'user'), ('moderator', 'moderator'), ('admin', 'admin')], default='user', help_text='Роль пользователя', verbose_name='Роль')),
